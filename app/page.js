...
export default function Home() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://nya-otakudesu.vercel.app/api/v1/detail/demount-play-sub-indo`
      )
      .then((res) => {
    ...
    axios
      .get(
        `https://nya-otakudesu.vercel.app/api/v1/detail/kamisama-katsudou-sub-indo`
      )
      .then((res) => {
  ...
  const data = [
    {
      datazs: dataz,
      foto: "/megumin.jpg",
      eps: "dmdp-episode-1-sub-indo",
      detail: "demount-play-sub-indo",
      trailer: "https://www.youtube.com/embed/I0vXkPt_bNA",
    },
    {
      datazs: dataz2,
      foto: "/overlord.jpg",
      eps: "kamikatsu-episode-1-sub-indo",
      detail: "kamisama-katsudou-sub-indo",
      trailer: "https://www.youtube.com/embed/IDevmGYN-OU",
    },
    {
      datazs: dataz3,
      foto: "/YoujoSenki.jpg",
      eps: "ont-episode-1-sub-indo",
      detail: "oshi-noko-sub-indo",
  ...
  return (
    <div>
          ...
          <div className="flex h-[700px] px-10 lg:py-[50px] md:py-[40px] max-[765px]:px-5 max-[765px]:py-[80px] max-[765px]:h-full">
            <div>
              ...
              <div className="lg:h-[380px]">
                <h1 className="lg:text-5xl pt-10 max-[765px]:text-2xl max-[765px]:pt-0 md:text-2xl">
                  {data[0].datazs && data[count].datazs.title}
                </h1>
                <h1 className="text-xl max-[765px]:text-lg">
                  {data[0].datazs && data[count].datazs.detail[1]}
                </h1>
                ...
                <p className="pt-10 max-[765px]:text-sm text-justify ">
                  ...
                  <span className="text-xs">
                    {data[0].datazs && data[count].datazs.detail[3]}
                  </span>
                  <br />
                  <span className="text-xs">
                    {data[0].datazs && data[count].datazs.detail[10]}
                  </span>
                </p>
              </div>
      ...
      <div>
        <ListanimeHome
          Tinggi={"px-10 py-[40px]"}
          judul={"On-going"}
          API={"https://otakudesu-anime-api.vercel.app/api/v1/ongoing/1"}
        ></ListanimeHome>
        <Trending />
        <ListanimeHome2
          kol={"18"}
          Tinggi={"px-10 py-[40px]"}
          judul={"Completed"}
          API={"https://otakudesu-anime-api.vercel.app/api/v1/completed/1"}
        ></ListanimeHome2>
      </div>
    </div>
  );
